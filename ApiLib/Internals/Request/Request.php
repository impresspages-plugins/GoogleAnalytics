...
namespace Plugin\GoogleAnalytics\ApiLib\Internals\Request;

use Plugin\GoogleAnalytics\ApiLib\Tracker;
use Plugin\GoogleAnalytics\ApiLib\Visitor;
use Plugin\GoogleAnalytics\ApiLib\Session;
use Plugin\GoogleAnalytics\ApiLib\CustomVariable;

use Plugin\GoogleAnalytics\ApiLib\Internals\ParameterHolder;
use Plugin\GoogleAnalytics\ApiLib\Internals\Util;
use Plugin\GoogleAnalytics\ApiLib\Internals\X10;

abstract class Request extends HttpRequest {

	/**
	 * @var \Plugin\GoogleAnalytics\ApiLib\Tracker
	 */
	protected $tracker;

	/**
	 * @var \Plugin\GoogleAnalytics\ApiLib\Visitor
	 */
	protected $visitor;

	/**
	 * @var \Plugin\GoogleAnalytics\ApiLib\Session
	 */
	protected $session;
	...
	/**
	 * @param \Plugin\GoogleAnalytics\ApiLib\Internals\ParameterHolder $p
	 * @return \Plugin\GoogleAnalytics\ApiLib\Internals\ParameterHolder
	 */
	...
	/**
	 * @return \Plugin\GoogleAnalytics\ApiLib\Tracker
	 */
	...
	/**
	 * @param \Plugin\GoogleAnalytics\ApiLib\Tracker $tracker
	 */
	...
	/**
	 * @return \Plugin\GoogleAnalytics\ApiLib\Visitor
	 */
	...
	/**
	 * @return \Plugin\GoogleAnalytics\ApiLib\Session
	 */
